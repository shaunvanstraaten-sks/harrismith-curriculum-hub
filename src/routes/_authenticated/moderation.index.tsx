...
function ModerationHome() {
  ...
  const cards = [
    { to: "/moderation/pre/new", title: t("dashboard.preModeration"), desc: t("dashboard.preModerationDesc"), icon: <ClipboardList size={28} />, color: "bg-brand-navy text-white" },
    { to: "/moderation/post/new", title: t("dashboard.postModeration"), desc: t("dashboard.postModerationDesc"), icon: <ClipboardCheck size={28} />, color: "bg-brand-green text-white" },
    { to: "/moderation/book/new", title: t("dashboard.bookControl"), desc: t("dashboard.bookControlDesc"), icon: <BookOpen size={28} />, color: "bg-brand-orange text-white" },
  ];
  return (
