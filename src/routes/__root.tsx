...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Harrismith Primary — Curriculum & Moderation Portal" },
      {
        name: "description",
        content:
          "Curriculum Management & Moderation portal for Harrismith Primary School — moderation forms, dashboards, and reports.",
      },
